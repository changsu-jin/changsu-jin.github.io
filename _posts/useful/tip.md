...
위의 방식에 의해 hibernate.default_batch_fetch_size:  100 으로 잡은 환경에서 83개의 데이터를 조회한다고 가정할 때, 한 번의 쿼리에 in절 항목이 83개가 들어가는 것이 아니고, 총 3번의 동일한 쿼리가 나가게 됩니다. 
...
## 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE3MTQ0MjcyNywtODIwNjM0ODM0XX0=
-->